...
SC_MODULE (calculosDE) {
	...
	// X1 tiene que esperar por la disponibilidad de Qs5a (3 etapas, multiplicación)
	// X5 tiene que esperar por la disponibilidad de Qf2a (3 etapas, multiplicación)
	// S3 tiene que esperar por la disponibilidad de Qs4 (3 etapas, suma)
	// X0 tiene que esperar por la disponibilidad de Qf1 (6 etapas, suma y cuadrado)
	// S1 tiene que esperar por la disponibilidad de Qs2 (3 etapas, suma)
	// F3 tiene que esperar por la disponibilidad de Qf2 (3 etapas, multiplicación (desplazamiento cuenta?))
	// F4 tiene que esperar por la dispoibilidad de Qf5 (6 etapas, dos multiplicaciones (desplazamiento cuenta?))
	...
	smallDelay_T<sc_uint<64>, 7> *retardoF4;
	  ...
	  SC_CTOR(calculosDE) {
		...
		SC_METHOD(arreglarDatos);
			sensitive << clk.pos() << reset.pos() << valX[2] << valX[3];
			...
			// CONEXIONES DE SEÑALES DE LÓGICA DE CONTROL Y DATOS
