...
smallDelay_T<sc_uint<64>, /*????*/> *retardoX1, *retardoX5, *retardoS3;
smallDelay_T<sc_uint<64>, /*????*/> *retardoX0;
smallDelay_T<sc_uint<64>, /*????*/> *retardoS1, *retardoF3;
smallDelay_T<sc_uint<64>, /*????*/> *retardoF4;
  ...
  SC_CTOR(calculosDE) {
	...
	SC_METHOD(arreglarDatos);
		sensitive << // RELLENAR LA LISTA DE SENSIBILIDAD PARA EL METODO arreglarDatos
...
// COMPLETAR A CONTINUACIÓN EL TAMAÑO QUE DEBE TENER CADA RETARDO
		...
		retardoX1 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoX1");
		retardoX5 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoX5");
		retardoS3 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoS3");
		retardoX0 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoX0");
		retardoS1 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoS1");
		retardoF3 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoF3");
		retardoF4 = new smallDelay_T<sc_uint<64>,  /*????*/>("retardoF4");
		...
		sh1->op( Qjk );		sh1->validIn( Vjk );	sh1->desplaz( /*????*/ );	sh1->validOut( /*????*/ );
		sh2->op( Qf2b );	sh2->validIn( Vf2b );	sh2->desplaz( /*????*/ );	sh2->validOut( /*????*/ );
		sh4->op( Qf5b );	sh4->validIn( Vf5b );	sh4->desplaz( /*????*/ );	sh4->validOut( /*????*/ );
